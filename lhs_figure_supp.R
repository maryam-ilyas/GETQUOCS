...
ff<- read.table("C:/Users/maryam/Dropbox/AMT_paper/lhr_full_maxcvg.txt")$x
gg<- read.table("C:/Users/maryam/Dropbox/AMT_paper/lhr_sampl_maxcvg.txt")$x
median(ff);median(gg)
...
X11()
par(op)
e<- paste("C:/Users/maryam/Dropbox/AMT_paper/lahore_max_cvg.png")
png(e,width = 5, height = 7, units = 'in', res = 300)
par(oma=c(3,3,0.5,0.5),mar=c(1,1,0,0))
par(mar=c(4,4,0,0))

#hh<- 
hist(ff,col=rgb(1,0,0,0.5),prob=TRUE,main="", xlab="temperature anomaly (°C)", ylab="probability", ylim=c(0,1.5))
 #hhh<- 
hist(gg, col=rgb(0,0,1,0.5), add=TRUE,prob=TRUE)#breaks=hh$breaks
...
ff<- read.table("C:/Users/maryam/Dropbox/AMT_paper/lhr_full_halfcvg.txt")$x
gg<- read.table("C:/Users/maryam/Dropbox/AMT_paper/lhr_sampl_halfcvg.txt")$x
...
X11()
par(op)
e<- paste("C:/Users/maryam/Dropbox/AMT_paper/lahore_half_cvg.png")
png(e,width = 5, height = 7, units = 'in', res = 300)
par(oma=c(3,3,0.5,0.5),mar=c(1,1,0,0))
par(mar=c(4,4,0,0))

hist(ff,col=rgb(1,0,0,0.5),prob=TRUE,main="", xlab="temperature anomaly (°C)", ylab="probability", ylim=c(0,1))
